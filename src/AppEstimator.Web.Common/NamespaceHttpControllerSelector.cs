...
namespace AppEstimator.Web.Common
{
    ...
    /// </summary>
    /// <remarks>
    ///     Used from Jaime Kurtz's ASP.NET Web API 2 book, GitHub repo:
    ///     https://github.com/jamiekurtz/WebApi2Book/blob/completed/src/WebApi2Book.Web.Common/NamespaceHttpControllerSelector.cs
    ///     Which was largely inspired by sample located at:
